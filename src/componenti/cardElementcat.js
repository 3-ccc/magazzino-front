...
function CardElementcat({ elem, i, resetn, testo, funz, piu }) {
      ...
      <div
        ...
        >
          ...
          <input
                  ...
                  placeholder={testo ? 'inserisci nome ' +testo : ''}
                />
          </div>
          <div className="col-4">
            {!isOnModify && <button
            ...
            <button
              ...
              data-toggle="popover"
              data-placement="top"
              data-content="aggiungi sottocategoria"
              data-trigger="hover"
              disabled={!isOk}
              onClick={() => {
                //chiamate-> if -1 nuovo altrim mod
